...
data["evolve"] = {
    ...
    "alarm": 0.02,
    "marginal_alarms": {
        n: {"z_score": round(r["z"], 1)}
        for n, r in sd.items() if r["kind"] == "marginal"
    },
}
        ...
        },
        {
            ...
            "thinking": {
                ...
                "pitfalls": [
                    ...
                    {"mistake": "“Skip cross-fitting to save time”", "consequence": "The estimator inherits the ML’s overfitting. CI coverage drops below nominal. The estimate may look precise but is centered on the wrong value.", "why": "Chernozhukov et al. (2018): cross-fitting is essential for sqrt(n)-consistency with data-adaptive nuisances. See the Math Bridge Level 4 notebook for a concrete nD demo: Lasso plug-in bias 0.39 vs DML bias 0.04."}
                ],
        ...
        },
        {
            ...
            "thinking": {
                ...
                "steps": [
                    ...
                    {"label": "Mental operation 2: Convert ATE to risk ratio scale", "detail": "Our estimated ATE = +0.2437. From the Monte Carlo oracle (ground truth, n=200k), the true potential-outcome means are mu1 = E[Y(1)] = 0.613 and mu0 = E[Y(0)] = 0.372. Using these oracle values for the risk ratio: <b>RR = 0.613 / 0.372 = 1.67.</b> (The AIPW estimator internally recovers mu1_hat, mu0_hat that agree with the oracle to ~0.001, so both give the same RR to 2dp.)"},
